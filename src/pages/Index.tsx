...
const Index = () => {
  ...
  return <div className="min-h-screen flex flex-col items-center justify-center p-6 relative" style={{
    ...
    backgroundRepeat: "no-repeat"
      ...
      <div className="max-w-4xl w-full text-center space-y-20 relative z-10">
        ...
        <div className="flex justify-center w-full px-4">
          {isLoading ? <div className="flex justify-center items-center h-[220px] w-full">
